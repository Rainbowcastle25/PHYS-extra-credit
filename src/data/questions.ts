...
export const questionBank: PracticeQuestion[] = [
  ...
  { id: 'meas1', topic: 'Measurement, Units & Error Analysis', prompt: 'A measurement gives 9.65 m/s² vs accepted 9.81 m/s². Percent error is nearest:', choices: ['0.16%', '1.63%', '3.26%', '16.3%'], correctIndex: 1, explanation: '|9.65-9.81|/9.81 × 100% ≈ 1.63%.' },
  { id: 'meas2', topic: 'Measurement, Units & Error Analysis', prompt: 'Two lengths (3.2 ± 0.1 cm) and (5.6 ± 0.2 cm) are added. Uncertainty in sum:', choices: ['0.1 cm', '0.2 cm', '0.3 cm', '0.02 cm'], correctIndex: 2, explanation: 'Absolute uncertainties add: 0.1 + 0.2 = 0.3 cm.' },
  { id: 'meas3', topic: 'Measurement, Units & Error Analysis', prompt: 'Precision refers to:', choices: ['Closeness to true value', 'Repeatability of measurements', 'Absence of error', 'Number of decimal places'], correctIndex: 1, explanation: 'Precision is about how consistently repeated measurements agree with each other.' },
  { id: 'eq1', topic: 'Equilibrium', prompt: 'For static equilibrium both conditions required are:', choices: ['ΣF=0 only', 'Στ=0 only', 'ΣF=0 and Στ=0', 'a=0 only'], correctIndex: 2, explanation: 'Both translational and rotational equilibrium must hold.' },
  { id: 'eq2', topic: 'Equilibrium', prompt: 'When taking torques in an equilibrium problem, the pivot should be placed:', choices: ['At the center of mass always', 'Where an unknown force acts, to eliminate it', 'At the right end only', 'Anywhere — the answer changes with pivot'], correctIndex: 1, explanation: 'Placing the pivot at an unknown force sets its torque to zero, simplifying the equation.' },
  { id: 'eq3', topic: 'Equilibrium', prompt: 'A uniform beam rests horizontally. Its weight acts at:', choices: ['Left end', 'Right end', 'Its center', 'Each support point'], correctIndex: 2, explanation: 'For a uniform beam, gravity acts at the geometric center (center of mass).' },
